...
class CustomerQuartalFigure(models.Model):
    ...
    frst_pmnt_date = models.CharField(max_length=10, blank=True, null=True)
    lst_pmnt_date_per_qrtr = models.CharField(max_length=10, blank=True, null=True)
